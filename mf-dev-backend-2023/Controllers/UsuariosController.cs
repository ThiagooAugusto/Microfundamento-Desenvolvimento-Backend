...
namespace mf_dev_backend_2023.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        public async Task <IActionResult>  Login(Usuario usuario)
        {
            ...
            if (senhaOk)
            {
                //fazer autenticação com Cookies - claims(credenciais) que podem ser recuperadas
                //e exibidas na tela
                ...
                //criar identidade com as claims
                var usuarioIdentity = new ClaimsIdentity(claims, "login");

                //
                ClaimsPrincipal principal = new ClaimsPrincipal(usuarioIdentity);

                //própriedades da autenticacao
            ...
            {
                ViewBag.Messsage = "Usuário e/ou senha inválidos!";
            }
            return View();
        }
